...
const pkgdef :Spk.PackageDefinition = (
  ...
  manifest = (
    ...
    actions = [
      ...
      ( title = (defaultText = "New Location Log"),
        command = .myCommand
    ...
    metadata = (
      ...
      license = (openSource = gpl2, notices = (defaultText = embed "notices.txt")),
      ...
      shortDescription = (defaultText = "Location tracker"),
      ...
      screenshots = [
        ...
        (width = 844, height = 542, png = embed "screenshots/view-track.png"),
        (width = 895, height = 386, png = embed "screenshots/demo-table.png"),
      ],
  ...
  alwaysInclude = ["usr/local/owntracks/docroot"],
